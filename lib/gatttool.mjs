        ...
        return new Promise((resolve, reject) => {
            let connectTimeout = setTimeout(() => {
                ...
                this.disconnect().then(() => {
                    reject(new Error("Couldn't connect in 5 seconds. Connection aborted."));
                });
            }, 5000);
            ...
            this._gatttool.stdout.on('data', (data) => {
                ...
                if (str.includes('Connection successful')) {
                    ...
                    this.disconnect().then(() => {
                        reject(new Error('Failed to connect to ' + this._address + ': ' + str.split(': ')[2]));
                    });
                }
    ...
    disconnect() {
        ...
        return new Promise((resolve, reject) => {
            ...
            this._gatttool.on('exit', () => {
                this._connected = false;
                console.log('Disconnected from ' + this._address);
                resolve();
            });
        });
    }
